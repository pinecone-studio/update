        ...
        >
          ...
          <div className="flex shrink-0 flex-wrap justify-end gap-2.5 pt-1 pb-2 sm:pb-0">
            ...
            <button
              ...
              className="rounded-lg bg-[#3B82F6] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#2563EB] disabled:opacity-50 dark:bg-[#3B82F6] dark:hover:bg-[#2563EB]"
            >
