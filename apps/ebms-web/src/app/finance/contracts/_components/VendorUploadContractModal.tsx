        ...
        >
          ...
          <div className="flex shrink-0 flex-wrap justify-end gap-2.5 pt-1 pb-2 sm:pb-0">
            <button
              type="button"
              onClick={handleClose}
              className="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-[#334155] dark:bg-[#1E293B] dark:text-[#D1DBEF] dark:hover:bg-[#24364F]"
            >
              Cancel
            </button>
            <button
              ...
              className="rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-500 disabled:opacity-50 dark:bg-[#1a5fb4] dark:hover:bg-[#2A9BFF]"
            >
