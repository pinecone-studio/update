      ...
      try {
        ...
        const rows: AuditRow[] = audits.map((a, idx) => {
          ...
          return {
            rowKey: a.id,
            logId,
            timestamp: a.computedAt || "",
            employeeId: a.employeeId,
            employeeName: employeeMap[a.employeeId] || a.employeeId,
            action,
            benefit: benefit?.name || a.benefitId,
            status,
            contractStartDate: benefit?.activeContract?.effectiveDate || "—",
            contractEndDate: benefit?.activeContract?.expiryDate || "—",
          };
        });
