    ...
    <section className="rounded-2xl border border-slate-200 p-3 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <input
          ...
          className="min-w-[180px] flex-1 bg-transparent text-sm text-slate-900 placeholder:text-slate-400 outline-none dark:text-white dark:placeholder:text-white/40"
