...
export function FinanceHistorySection() {
	...
	const benefitOptions = useMemo(
		() =>
			Array.from(
				new Set(requests.map((r) => getBenefitName(r.benefitId))),
			).sort(),
	...
	if (loading) {
		return (
			<div className="space-y-6">
				<section className="rounded-3xl border border-slate-200 bg-white/90 p-6 dark:border-white/10 dark:bg-[#16142a]">
