...
const STATUS_STYLES: Record<BenefitCardProps["status"], string> = {
  ...
  ELIGIBLE: "bg-blue-100 text-blue-800 dark:bg-blue-950/80 dark:text-blue-300",
  LOCKED: "bg-slate-100 text-slate-600 dark:bg-slate-950/80 dark:text-slate-300",
  PENDING:
    "bg-amber-100 text-amber-800 dark:bg-amber-950/80 dark:text-amber-300",
  REJECTED: "bg-red-100 text-red-800 dark:bg-red-950/80 dark:text-red-300",
};
