...
export function FinanceHeader() {
	...
	return (
		<header className="sticky top-0 z-50 h-[72px] w-full border-b border-slate-200 bg-white/95 px-3 backdrop-blur-md dark:border-white/10 dark:bg-[#0A121B]/95 sm:px-4">
					...
					>
						<div className="flex min-w-0 items-center gap-2">
							...
							<div className="leading-[24px]">
								<p className="flex items-start justify-start text-[20px] font-semibold tracking-[0px] text-slate-900 dark:text-white">
									UPDATE
								</p>
							</div>
						</div>
