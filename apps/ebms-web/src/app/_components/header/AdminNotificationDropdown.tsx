...
function NotificationDot({ n }: { n: AdminNotification }) {
  const dotClass = n.unread ? "bg-red-500" : "bg-slate-400 dark:bg-slate-500";
  return (
    <span
...
export function AdminNotificationDropdown({
  ...
  return (
    <div className="absolute right-0 top-full z-50 mt-3 w-[min(380px,calc(100vw-2rem))] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#0E1622] dark:shadow-[0_28px_70px_-40px_rgba(0,0,0,0.85)]">
