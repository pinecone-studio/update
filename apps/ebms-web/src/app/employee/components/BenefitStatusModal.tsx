		...
		>
			<div className="flex min-h-full items-center justify-center p-2 sm:p-4">
				...
				>
					...
					>
						<div className="flex items-start justify-between gap-3 sm:gap-4">
							<div className="flex min-w-0 items-start gap-3">
								<div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-[14px] border border-slate-200 bg-slate-100 text-slate-700 sm:h-14 sm:w-14 dark:border-slate-600/50 dark:bg-slate-800/70 dark:text-white/90">
							...
							<button
								type="button"
								onClick={onClose}
								className="grid h-10 w-10 place-items-center rounded-[14px] border border-slate-200 bg-slate-100 text-slate-600 transition hover:bg-slate-200 sm:h-11 sm:w-11 dark:border-slate-600/50 dark:bg-slate-800/70 dark:text-white dark:hover:bg-slate-700/70"
								aria-label="Close"
							>
								<FiX size={20} />
							</button>
					...
					{canRequest ? (
						<div
							className={`border-t px-3 py-3 sm:px-5 sm:py-4 ${theme.footer}`}
						>
							<button
								type="button"
