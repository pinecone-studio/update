					...
					>
						<div className="flex min-w-0 items-center gap-2">
							...
							<div className="leading-[24px]">
								<p className="flex justify-start items-start text-[20px] font-semibold tracking-[0px] text-[var(--text-primary)]">
									UPDATE
								</p>
							</div>
						</div>
						...
						<div className="hidden md:flex items-center gap-2 sm:gap-3">
							<div className="relative" ref={notificationRef}>
								<button
									...
									className="relative grid h-10 w-10 place-items-center rounded-full border border-slate-200 ring-1 ring-transparent transition hover:bg-slate-50 dark:border-white/10 dark:hover:bg-white/10"
