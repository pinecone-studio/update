...
export function HelpFeedbackWidget() {
  ...
  if (!open) {
    return (
      <button
        type="button"
        className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full border border-gray-300 bg-slate-800 text-white shadow-lg duration-200 hover:bg-slate-700 sm:bottom-8 sm:right-8 sm:h-16 sm:w-16 lg:bottom-14 lg:right-14"
  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-50 flex h-[70vh] max-h-[420px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl sm:inset-x-auto sm:right-8 sm:w-[340px] lg:bottom-14 lg:right-14">
      <div className="w-full rounded-t-2xl bg-[#2196F3]">
            ...
            <div className="flex-shrink-0 border-t border-slate-200 p-3">
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-black placeholder:text-slate-400 focus:border-[#2196F3] focus:outline-none focus:ring-1 focus:ring-[#2196F3]"
                />
                <button
                  type="button"
            ...
            {feedbackSubmitted ? (
              <div className="flex flex-col items-center justify-center py-6 text-center">
                ...
                <button
                  ...
                  className="mt-4 text-sm text-[#2196F3] underline hover:text-[#1976D2]"
                >
                      ...
                      {hasOpenFeedback && (
                        <div
                          className={`min-h-0 overflow-y-auto ${
                            showVoteOnly ? "flex-1" : "flex-shrink-0 border-b border-slate-200"
                          }`}
                        >
                        ...
                        <div className="flex-shrink-0 flex flex-col gap-3 pt-3">
                          {hasOpenFeedback && (
                            <button
                              ...
                              className="self-start text-xs text-slate-500 hover:text-black"
                            >
                              ← Back to votes
                            </button>
                          )}
                          ...
                          <div>
                            ...
                            <textarea
                              ...
                              rows={3}
                              className="w-full resize-none rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-black placeholder:text-slate-400 focus:border-[#2196F3] focus:outline-none focus:ring-1 focus:ring-[#2196F3]"
                            />
                          </div>
                          <div className="flex items-center gap-2">
                            <input
