...
import { FiCheck, FiStar, FiActivity, FiInfo } from "react-icons/fi";
import { CgArrowRight } from "react-icons/cg";
import { BenefitPortfolio } from "@/app/_components/BenefitPortfolio";
import { BENEFITS } from "@/app/_components/benefits-data";
	...
	return (
		<div>
			...
			<div className="min-h-screen w-full bg-[#0f172a] p-8">
					...
					<div className="min-w-0 rounded-[10px] bg-[#334155] p-6 flex flex-col min-h-[134px]">
						<div className="flex justify-between items-start">
							<div>
								...
								<p className="text-[48px] font-bold text-white leading-none mt-1">
									{BENEFITS.filter((b) => b.status === "ELIGIBLE").length}
								</p>
				...
				<BenefitPortfolio benefits={BENEFITS} />
				<div className="mt-6 rounded-lg bg-[#1f2a40] p-5 flex gap-4">
					...
					<div className="flex-1 min-w-0">
						...
						<p className="text-sm text-[#94a3b8] mt-1">
							Your eligibility is automatically tracked based on tenure (185
							days) and OKR performance (82%). You'll receive notifications when
							you become eligible for new benefits.
						</p>
					</div>
				</div>
			</div>{" "}
