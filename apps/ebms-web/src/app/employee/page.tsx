					...
					<>
						...
						<section className="mt-2 w-full sm:mt-8 lg:mt-10">
							<div className=" sm:mb-6">
								<h2 className="text-[18px] font-semibold tracking-[-0.4px] text-[var(--text-primary)] sm:text-[20px] sm:tracking-[-0.6px]">
									{title}
								</h2>
								<p className="mt-1 text-[14px] text-[var(--text-secondary)] sm:text-[15px]">
									{subtitle}
								</p>
							</div>
