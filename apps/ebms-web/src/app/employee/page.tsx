...
export default function EmployeeDashboardPage() {
  ...
  const renderContractTaskCard = (
    task: { requestId: string; benefitName: string; uploadedUrl?: string | null },
  ) => {
      ...
      >
        ...
        {!needsUpload ? (
          <div className="mt-2 flex items-center gap-3">
            <span className="text-xs text-emerald-300">Signed contract uploaded</span>
            <a
