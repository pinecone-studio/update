...
export function NotificationSearchBar({
  ...
  return (
    <section className="rounded-2xl border border-slate-200  p-3 shadow-sm  ">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <button
          onClick={onMarkAllAsRead}
            className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700 transition hover:bg-slate-100 dark:border-[#243041] dark:bg-[#111A2A] dark:text-slate-200 dark:hover:bg-[#1A2333]"
          >
            Mark All as Read
          </button>
      </div>
