...
const cardClass =
	"rounded-xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-[#1e1a35]";
...
function ApprovalItem({
	...
	return (
		<label className="flex cursor-pointer items-center gap-3 rounded-lg border border-slate-200 bg-white p-2.5 transition hover:bg-slate-50 dark:border-white/10 dark:bg-[#16142a] dark:hover:bg-[#2a2540]">
			<div
