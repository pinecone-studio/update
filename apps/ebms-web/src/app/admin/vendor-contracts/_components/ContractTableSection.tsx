    ...
    <section className="overflow-hidden rounded-3xl bg-white p-4 dark:border-[#2C4264] dark:bg-[#181743]/50 sm:p-6">
      <div className="flex flex-col gap-4 sm:gap-6">
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-semibold dark:text-white sm:text-[26px]">
            Contracts
          </h2>
        </div>
        <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
            ...
            <input
              ...
              className="h-11 w-full min-w-0 rounded-lg border border-transparent bg-[#FFFFFF]/10 pl-12 pr-4 text-5 text-slate-200 placeholder:text-slate-200 outline-none focus:border-white/70 dark:text-white dark:placeholder:text-[#FFFFFF80]/50 dark:focus:border-white/50 sm:w-[280px] lg:w-[368px]"
            />
            </div>
          </div>
          <button
