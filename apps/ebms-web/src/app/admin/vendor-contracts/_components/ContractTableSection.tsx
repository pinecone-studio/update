					...
					<div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4">
						<div className="relative w-full sm:w-auto">
							<select
								...
								className="h-10 min-w-[82px] appearance-none rounded-lg border border-slate-200 bg-slate-50 pl-3 pr-9 text-slate-900 outline-none focus:border-blue-500 dark:border-[#6F5AA8] dark:bg-[#FFFFFF]/10 dark:text-white dark:focus:border-[#B18CFF]"
							>
