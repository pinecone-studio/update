			...
			<section className="grid min-h-0 flex-1 grid-cols-1 grid-rows-[auto_1fr] gap-8 px-6 py-6 overflow-hidden lg:grid-cols-[auto_1fr] lg:grid-rows-1">
				...
				<div className="flex flex-col gap-8 lg:min-w-[454px]">
					{[1, 2].map((i) => (
						<article
							key={i}
							className="flex h-[320px] w-full max-w-[454px] flex-col rounded-2xl px-[54px] py-[48px] shadow-lg ring-1 ring-slate-200 dark:ring-white/10"
						>
				...
				<article className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-[24px] border border-slate-200 bg-white/90 dark:border-[#262626] dark:bg-[#16142a] sm:p-6 lg:h-[620px]">
