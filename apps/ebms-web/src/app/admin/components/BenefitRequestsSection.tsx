...
export function BenefitRequestsSection({
	...
	return (
		<article className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white/90 p-3 sm:rounded-[24px] sm:p-6 dark:border-[#262626] dark:bg-[#16142a] lg:h-[675px] overflow-y-auto">
			<div className="mb-3 flex shrink-0 flex-col gap-3 px-2 pt-2 sm:mb-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:px-6 sm:pt-6">
				<h2 className="text-base font-bold text-slate-900 sm:text-lg dark:text-white lg:text-[24px]">
				...
				<div className="w-full overflow-x-auto rounded-2xl border border-slate-200 sm:w-auto dark:border-white/30">
					<div className="flex h-11 min-w-max gap-1.5 sm:h-[49px] sm:w-[472px]">
							...
							<button
								...
								className={`shrink-0 rounded-2xl px-[22px] py-2.5 text-[16px] font-medium transition ${
									statusFilter === value
										...
										: "bg-transparent text-slate-600 hover:text-slate-900 dark:text-white"
								}`}
							>
								{label}
							</button>
