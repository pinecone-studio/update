    ...
    item.type === "request"
      ...
      : item.type === "document"
        ...
        : item.type === "eligibility"
          ...
          : item.type === "warning"
            ? "text-amber-600 bg-amber-50 dark:text-amber-300 dark:bg-amber-500/20"
            : "text-slate-600 bg-slate-50 dark:text-white/60 dark:bg-white/10";

  const unreadClasses = item.unread
    ? "border-slate-200 shadow-[0_12px_30px_-24px_rgba(15,23,42,0.35)] dark:border-white/20 dark:bg-white/5 dark:shadow-none"
    : "border-slate-100 shadow-sm dark:border-white/10 dark:bg-white/5 dark:shadow-none";
